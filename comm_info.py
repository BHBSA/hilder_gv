...
class Building:
    def __init__(self, co_index, co_id=None, bu_num=None, bu_id=None, bu_name=None, bu_all_house=None,
...
class House:
    def __init__(self, co_index, co_id=None, bu_id=None, ho_num=None, ho_floor=None, ho_type=None,
