...
class Heze(Crawler):
            ...
            for ho_list in ho_table[1:-1]:
                ...
                for house in honum_list:
                    ...
                    if len(ho_url) == 1:
                        ...
                        info = re.search(r"：(.*?)<br>.*?：(.*?)<br>(.*?)<br><hr>.*?:(.*?)m.*?<br>.*?:(.*?)<br>.*?:(.*?)m",ho_info)
                        ...
                        ho.ho_build_size = con.xpath("//span[@id='ctl00_ContentPlaceHolder2_lb_house_build_area']/text()")[0]
                        ho.ho_share_size = con.xpath("//span[@id='ctl00_ContentPlaceHolder2_lb_house_share_area']/text()")[0]
                        ho.ho_true_size = con.xpath("//span[@id='ctl00_ContentPlaceHolder2_lb_house_inside_area']/text()")[0]
    ...
    def comm_info(self,con,):
       # 小区及楼栋
            ...
            comm.co_name = con.xpath("//span[@id='ctl00_ContentPlaceHolder2_web_item_retail1_lb_item_name']/text()")[0]  #小区名称
